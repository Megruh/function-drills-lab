...
function theEliminator(nameArr, name2){
...
function goldForChocolate(gold){
  let frog = gold / 3
  console.log(frog)
}

let totalFrogs = goldForChocolate(4)
...
function goldForChocolate2(gold){
  let frog2 = Math.floor(gold / 3)
  console.log(frog2)
}

let totalFrogs2 = goldForChocolate2(4)
